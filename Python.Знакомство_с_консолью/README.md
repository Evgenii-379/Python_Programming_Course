...
- [square and rectangle](https://github.com/Evgenii-379/Python_Programming_Course/blob/main/%D0%A1%D0%BD%D0%B8%D0%BC%D0%BE%D0%BA%20%D1%8D%D0%BA%D1%80%D0%B0%D0%BD%D0%B0%202026-02-02%20115926.png)
...
mortgage_rate_percent = int(input("Введите, какой процент (%) уходит на ипотеку: "))
living_expenses_percent = int(input("Введите, какой процент (%) уходит на жизнь: "))

mortgage_month = monthly_salary * mortgage_rate_percent / 100
living_month = monthly_salary * living_expenses_percent / 100

saved_month = monthly_salary - mortgage_month - living_month

mortgage_year = mortgage_month * 12
saved_year = saved_month * 12

print("На ипотеку было потрачено:", mortgage_year, "рублей")
print("Было накоплено:", saved_year, "рублей")

```

- [mortgage_percent](https://github.com/Evgenii-379/Python_Programming_Course/blob/main/%D0%A1%D0%BD%D0%B8%D0%BC%D0%BE%D0%BA%20%D1%8D%D0%BA%D1%80%D0%B0%D0%BD%D0%B0%202026-02-02%20120118.png)
